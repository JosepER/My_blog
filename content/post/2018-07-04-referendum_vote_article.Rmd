...
t_1 %>%
  mutate(`Lower bound CI` = percent(round(`Lower bound CI`,3)),
   ...
   datatable(caption = "Table 1: Confidence intervals using bootstrap resamples with Quota design.",
            autoHideNavigation = T, rownames = F)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
t_2 %>%
     datatable(caption = "Table 1: Standard errors under different sampling designs.",
            autoHideNavigation = T, rownames = F)
...
[^3]: See his comments in Spanish [here](https://www.elperiodico.com/es/politica/20171006/resultados-referendum-cataluna-2017-6319340)

[^4]: The technical specifications of the survey can be found [here](http://upceo.ceo.gencat.cat/wsceop/6408/Abstract%20in%20English%20-863.pdf) (in English) 
and with greater detail [here](http://upceo.ceo.gencat.cat/wsceop/6408/Fitxa%20t%C3%A8cnica%20-863.pdf) (in Catalan)
...
[^15]: See the table at the end of the technical report of the survey [here](http://upceo.ceo.gencat.cat/wsceop/6408/Fitxa%20t%C3%A8cnica%20-863.pdf) (In Catalan) 
