...
_Figure 1_
**TO DO: link this to the shiny app**
...
shinyAppDir(appDir = "https://bookdown.org/content/1227/",
            options = list(width = "120%", height = 600))

```

<iframe src="https://bookdown.org/content/1227/" width="1200" height="740"> </iframe>
...
input_list_16$table_characters_season %>% 
  knitr::kable(col.names = c("Season", "Distinc characters in IMDb", "Distinct characters in scipts"), 
