...
_Figure 1_ can be used to obtain more information on appearances of individual characters. Use the manual function of the Shiny app below and type in their names. Rembember however that valid scripts for most episodes for season 2, 3 and 4, plus the last episode of season 7 were not available.

```{r, eval = FALSE,echo = FALSE}

#to do: check if it works online!
#to do: change theme in original shiny app and GoT_public
#to do: tweak a bit more to reduce space for labels

#read_rds("C:/Users/josep/Desktop/R/GoT/output_articles/static_shiny_graph_16.rds")

shinyAppDir(appDir = "https://josep-espasa.shinyapps.io/18_GoT_characters_appearances/",
            options = list(width = "120%", height = 600))

#1
#<iframe src="https://josep-espasa.shinyapps.io/18_GoT_characters_appearances/" width="1200" height="740"> </iframe>
...
<iframe id="myIframe" src="https://josep-espasa.shinyapps.io/18_GoT_characters_appearances/" scrolling="no" frameborder="no"></iframe>
<script>
  iFrameResize({
...
<iframe src="https://josep-espasa.shinyapps.io/18_GoT_characters_appearances/" width="1024" height="633"> </iframe>
...
input_list_16$table_characters_season %>% 
  knitr::kable(col.names = c("Season", "Characters IMDb", "Characters scipts"), 
...
** TO DO:**
Make sure that I made it clear that I'm counting the number of times a character speaks!
...
[^7]: This is, the number of times they appear to speak.
